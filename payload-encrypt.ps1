...
Powershell script to XOR shellcode with a key and then Base64 encode it ready to be stored inside Expeditus C# loader
...
Write-Host "Encrypted payload to paste into strEncryptedPayload variable in expeditus.cs: $([Convert]::ToBase64String($ciphertext))"